...
// Standalone demo (separate binary from NeuroGame): thin wrapper around DecoderModule
// (src/decoder_module.cpp), which holds the actual logic and rendering so it can also run
// inside MultiDemo's combined view. See decoder_module.hpp for what this demo shows.
