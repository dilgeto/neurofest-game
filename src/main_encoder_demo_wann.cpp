...
// Standalone demo (separate binary from NeuroGame): thin wrapper around EncoderWannModule
// (src/encoder_wann_module.cpp), which holds the actual logic and rendering so it can also
// run inside MultiDemo's combined view. See encoder_wann_module.hpp for what this demo shows.
